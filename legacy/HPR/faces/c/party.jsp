...
<div class="middle">
  <p style="padding-bottom:20px;font-size:18px;font-weight:bold;padding-left:50px;">Seats ocupied by Parties in the four Parliamentary terms<p>
         


                      <p class="f" style="padding-bottom:20px;text-decoration:underline;font-weight:bold;" >2010-2015</p>
                      <img src="/HPR/images/pdficon.png" style="width:30px;height:30px;float:left;padding-left:20px;" />
                      <p style="padding-left:20px;padding-bottom:10px;"><a href="/HPR/document/Seats occupied by Parties in the four Parliamentary terms.pdf" target="_blank" style="text-decoration:none;;color:black;"><h4 >Download</h4></a>
</p>
