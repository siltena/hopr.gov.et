        ...
        <head>
            ...
            <script language="javascript">
                ...
                function call_login(num){
                    ...
                    var url = "condisplay.jsp?num="+num;
 ...
 <li class="li1"><a href="#"> <p class="langua">Archive</p></a>
        ...
        <ul class="nav2">
                ...
                <div class="content">
                        ...
                        <fieldset style="margin-top:40px;padding-left:10px;margin-left:20px;padding-bottom:20px;border:2px solid #a9c8f7"><legend style="text-align:center;font-size:18px;color:black;">Table of Content</legend>

                        <a href="javascript:call_login(1)"  style="color:black;" >Preamble</a><br>
                        <a href="javascript:call_login(2)" style="color:black;" >Chapter 1  General Provisions </a><br>
                        <a href="javascript:call_login(3)" style="color:black;" >Chapter 2  Fundamental Principles of the Constitution </a><br>

                        <p style="color:black;" style="color:black;" >Chapter 3:  Fundamental Rights and Freedoms </p>
                        <a href="javascript:call_login(4)"  style="color:black;" >Part 1.           Human Rights </a><br>
                        <a href="javascript:call_login(5)"  style="color:black;" >Part 2.            Democratic Rights </a><br>
                        <a href="javascript:call_login(6)"  style="color:black;" >Chapter 4:    State Structure</a><br>
                        <a href="javascript:call_login(7)"  style="color:black;" >Chapter 5:    The Structure and Division of Powers</a><br>
                        <p style="color:black;" >Chapter 6:  The Federal Houses </p><br>
                        <a href="javascript:call_login(8)"  style="color:black;" >Part 1.        The House of Peoples' Representatives </a><br>
                        <a href="javascript:call_login(9)"  style="color:black;" >Part 2.        The House of the Federation</a><br>
                        <a href="javascript:call_login(10)"  style="color:black;" >Chapter 7:    The Presidence of the Republic</a><br>
                        <a href="javascript:call_login(11)"  style="color:black;" >Chapter 8:    The Executive</a><br>
                        <a href="javascript:call_login(12)"  style="color:black;" >Chapter 9:    Structure and Powers of the Courts</a><br>
                        <a href="javascript:call_login(13)"  style="color:black;" >Chapter 10:  National Policy Principles and Objectives</a><br>
                        <a href="javascript:call_login(14)"  style="color:black;" >Chapter 11:  Miscellaneous Provisions</a><br>
                        </fieldset>
                    </div>
