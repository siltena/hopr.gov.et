...
<div class="middle">
                            ...
                            <fieldset style="margin-top:40px;margin-right:40px; margin-left:30px;bottom:20px;border:2px solid #a9c8f7"><legend style="text-align:center;font-size:18px">Feedback Form</legend>
                                ...
                                <form  method="POST" name="log">
                                    ...
                                    <table align="center">
                                        ...
                                        <tr>
                                            <td>Comment**</td>
                                            <td><textarea cols="25" rows="6" name="comment"></textarea></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                        <td>&nbsp;</td> <td> <img src="Cap_Img.jsp" width="150px" height="40px"></td></tr>
                                        <tr> <td>&nbsp;</td><td><input type="button" value="Refresh Image" onClick="window.location.href=window.location.href"></td></tr>
                                        <tr>
                                        <td>&nbsp;</td><td> Please enter the string shown in the image.</td></tr>
                                        <tr>
                                            <td>&nbsp;</td> <td ><input name="number" type="text">**</td>
                                        </tr>

                                        <tr>

                                            <td>&nbsp;</td><td ><input type="submit" name="submit" value="Save"><input type="hidden" name="check" value="che" /></td>
                                        </tr>
                                    </table>
                                </form>
                            </fieldset>
